...
type OSArgs struct {
	...
	DefaultBackendService NamespaceValue `long:"default-backend-service" default:"" description:"default service to serve 404 page. If not specified Zorp serves http 400"`
	DefaultCertificate    NamespaceValue `long:"default-ssl-certificate" default:"" description:"secret name of the certificate"`
	ConfigMap             NamespaceValue `long:"configmap" description:"configmap designated for Zorp" default:"default/zorp-configmap"`
	...
	Test                  bool           `short:"t" description:"simulate running Zorp"`
	Help                  []bool         `short:"h" long:"help" description:"show this help message"`
	IngressClass          string         `long:"ingress.class" default:"zorp" description:"ingress.class to monitor in multiple controllers environment"`
}
